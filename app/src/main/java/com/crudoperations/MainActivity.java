...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set ValueEventListener after setting adapter
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                // Check if adapter is null before setting it
                if (taskAdapter == null) {
    ...
    private void showAddTaskDialog() {
        ...
        builder.setPositiveButton("Add", (dialog, which) -> {
            ...
            if (!TextUtils.isEmpty(taskName)) {
                ...
                task.setId(id); // Set the ID for the task
                task.setName(taskName); // Set the name for the task
                databaseReference.child(id).setValue(task); // Save the task to Firebase
